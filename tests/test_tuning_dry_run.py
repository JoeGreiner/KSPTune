...
def test_run_until_stopped_writes_best_so_far_after_keyboard_interrupt(
    ...
    def fake_run_replay_for_solver_configuration(**kwargs):
        return {
            ...
            "schema_errors": [],
            "subprocess_walltime_seconds": 0.2,
            "failure_reason": None,
            "replay_result": {
                "objective_sec": 0.1,
                "total_wall_time_seconds": 0.3,
                "matrix_load_time_seconds": 0.01,
                "solver_setup_time_seconds": 0.02,
                "solve_time_seconds_mean": 0.1,
                ...
                "reason_code": 2,
                "peak_memory_megabytes_max": 64.0,
